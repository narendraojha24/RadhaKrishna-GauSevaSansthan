...
export default function Gallery() {
  ...
  const imagesByCategory: Record<string, { src: string; alt: string }[]> = {
    gaushala: [
      ...
      { src: "gg1 (55).jpg", alt: "गौशाला 5" },
      { src: "gg1 (50).jpg", alt: "गौशाला 5" },
      { src: "gg1 (46).jpg", alt: "गौशाला 5" },
    ...
    spiritual: [
      ...
      { src: "gallery3/g3 (23).jpg", alt: "" },
      { src: "gallery4/g4 (6).jpg", alt: "" },
      { src: "gallery4/g4 (7).jpg", alt: "" },
      { src: "gallery4/g4 (8).jpg", alt: "" },
      { src: "gallery4/g4 (11).jpg", alt: "" },
      { src: "gallery4/g4 (12).jpg", alt: "" },
      { src: "gallery4/g4 (13).jpg", alt: "" },
      { src: "gallery4/g4 (14).jpg", alt: "" },
      { src: "gallery4/g4 (15).jpg", alt: "" },
      { src: "gallery4/g4 (16).jpg", alt: "" },
      { src: "gallery4/g4 (19).jpg", alt: "" },
      { src: "gallery4/g4 (21).jpg", alt: "" },
      ...
      { src: "gallery4/g4 (66).jpg", alt: "" },
      { src: "gallery4/g4 (67).jpg", alt: "" },
      { src: "gallery4/g4 (70).jpg", alt: "" },
      { src: "gallery4/g4 (71).jpg", alt: "" },
      { src: "gallery4/g4 (73).jpg", alt: "" },
      { src: "gallery4/g4 (74).jpg", alt: "" },
      { src: "gallery4/g4 (76).jpg", alt: "" },
      { src: "gallery4/g4 (77).jpg", alt: "" },
      { src: "gallery4/g4 (89).jpg", alt: "" },
      { src: "gallery4/g4 (92).jpg", alt: "" },
      { src: "gallery4/g4 (93).jpg", alt: "" },
      { src: "gallery4/g4 (94).jpg", alt: "" },
      { src: "gallery4/g4 (95).jpg", alt: "" },
      { src: "gallery4/g4 (96).jpg", alt: "" },
